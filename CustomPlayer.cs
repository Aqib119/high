...
namespace SimpleFPS
{
    ...
    if (AttitudeSensor.current != null)
    {
        ...
        protected override void ProcessInput(NetworkedInput input)
        {
            ...
            {
                if (Object.HasInputAuthority && LoadingUI.Instance.calibrationPanel.activeSelf && !StopCalibrtion)// && !CalibrationManagerFusion.Instance.isLocalReady)
                {
                    //CheckTilt();
